...
public class LecturerPrelegentBoxCell extends TableCell<Object, String> {

	private ComboBox<String> comboBox;
	private ObservableList<String> events;

	public LecturerPrelegentBoxCell() {
	}

	public LecturerPrelegentBoxCell(ObservableList<String> events) {
		this.events = events;
	}
